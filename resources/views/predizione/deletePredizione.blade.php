    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class='panel-body'>
                    <p class="confirm-delete">The predizione <strong>will not be removed</strong> from the data base</p>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class='panel-body'>
                    <p class="confirm-delete">The predizione <strong>will be permanently removed</strong> from the data base</p>
